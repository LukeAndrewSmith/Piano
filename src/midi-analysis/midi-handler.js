...
export const subscribedToTemplate = {
    'played': {
        'status': false, 
        'callback': null
    },
...
export function MidiHandler(midiInput, subscribedTo ) {
    ...
    function handleMessage(message) {
        ...
        if (subscribedTo.exerciseData.status) {
            exerciseData = extractExerciseAnalysisData(played); // TODO: this is not efficient, should simply update the existing array if slow
            // exerciseData = updateExerciseAnalysisData(exerciseData,playedNew); // TODO: finish this func
            subscribedTo.exerciseData.callback(exerciseData);
        }
    }
...
function updatePlayedNotes( rawMessage, played ) {
    /*
    Does....
    Input:
    Return:
...
function updateExerciseAnalysisData( exerciseAnalysisData, played ) {
    /*
    Does....
    Input:
    Return:
...
function extractExerciseAnalysisData( played ) {
